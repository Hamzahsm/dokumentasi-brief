...
<html lang="en">
  <head>
    ...
    <title>Tim Sales OESMAN</title>
  </head>
  <body style="background-color: #570000;">

<div class="container" style="margin-top: 30px;">
    <div class="col-8" style="margin: auto;">
        <form style="background-color: white; padding: 20px; border-radius: 10px;" action="timsales.php" method="POST">
        <div style="text-align: center; margin-bottom: 20px;">
              <img src="https://oesman.id/wp-content/uploads/2020/08/OESMAN_logo-4.png" width="240px" height="80px" class="img-fluid">
              <h4 style="font-weight: bold; margin: 20px 0;">TIM SALES OESMAN</h4>
        </div>
              ...
              <?php
                    ...
                    <div class="link login-link text-center mt-3"><a href="forgot-password-sales.php">Lupa Password?</a> | <a href="signup-user-sales.php"> Daftar</a></div>
                    </form>
    </div>
</div>
